	...
	<div class="container">
		...
		<table class="table table-hover text-center mt-3">
			...
			<tbody>
				...
				%>
			    <tr class="row">
			    	<td class="col-1"><%= eachMap.get("id") %></td>
			    	<td class="col-2"><img src=<%= eachMap.get("image") %> width="50" height="70"></td>
			    	<td class="col-9"><a href="/lesson02/quiz08_1.jsp?id=<%= eachMap.get("id") %>"><%= eachMap.get("title") %></a></td>	
		    	</tr>
				<%    	
			    }
				%>
